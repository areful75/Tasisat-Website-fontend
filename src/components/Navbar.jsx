...
const Navbar = () => {
  ...
  return (
    <nav className="w-full bg-[#0B1026]/90 shadow-md sticky top-0 z-50 backdrop-blur-md">
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <ul className="hidden lg:flex items-center gap-6 text-[#F8FAFC] font-medium">
            ...
            >
              ...
              <div
                className={`absolute top-10 left-0 w-64 bg-[#0B1026] border border-[#0089A8]/30 shadow-xl rounded-xl overflow-hidden transition-all duration-300 ${
                  serviceDropdownOpen
                    ? "opacity-100 visible translate-y-0"
                    : "opacity-0 invisible -translate-y-2"
                }`}
            ...
            >
              ...
              <div
                className={`absolute top-10 left-0 w-72 max-h-[500px] overflow-y-auto bg-[#0B1026] border border-[#0089A8]/30 shadow-xl rounded-xl transition-all duration-300 ${
                  projectDropdownOpen
                    ? "opacity-100 visible translate-y-0"
                    : "opacity-0 invisible -translate-y-2"
                }`}
            ...
            <li>
              <NavLink to="/rnd" className={navClass}>
                R&D
              </NavLink>
            </li>
            ...
            <li>
              <NavLink to="/contract" className={navClass}>
                Contact
              </NavLink>
            </li>
          ...
          <div className="hidden lg:flex items-center gap-3 mr-4">
            <a
              href="https://www.facebook.com/UlteriorEngineeringIntl"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/mdarefulamin/"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 flex items-center justify-center rounded-full bg-[#0089A8]/20 text-[#00B4D8] border border-[#0089A8]/40 hover:bg-[#00B4D8] hover:text-[#0B1026] transition"
            >
            ...
            <a
              href="https://www.instagram.com/the_areful_omi/"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 flex items-center justify-center rounded-full bg-[#0089A8]/20 text-[#00B4D8] border border-[#0089A8]/40 hover:bg-[#00B4D8] hover:text-[#0B1026] transition"
            >
            ...
            <a
              href="https://www.youtube.com/@ulteriorengineeringltd/featured"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 flex items-center justify-center rounded-full bg-[#0089A8]/20 text-[#00B4D8] border border-[#0089A8]/40 hover:bg-[#00B4D8] hover:text-[#0B1026] transition"
            >
      ...
      {/* MOBILE MENU */}
      <div
        className={`lg:hidden bg-[#0B1026] border-t border-[#0089A8]/30 shadow-md overflow-hidden transition-all duration-300 ${
          mobileMenuOpen ? "max-h-[1200px] py-4" : "max-h-0"
        }`}
      >
        <ul className="flex flex-col px-6 space-y-3 text-[#F8FAFC] font-medium">
